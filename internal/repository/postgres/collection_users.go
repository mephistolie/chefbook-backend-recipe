...
func (r *Repository) SaveCollectionToRecipeBook(ctx context.Context, collectionId, userId uuid.UUID) error {
	query := fmt.Sprintf(`
...
func (r *Repository) RemoveCollectionFromRecipeBook(ctx context.Context, collectionId, userId uuid.UUID) error {
	query := fmt.Sprintf(`
		DELETE FROM %s
